...
<div>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="#">Nick's Tropical Autocenter</a>
...
<form action="CustomerServlet" method="post" class="container">
...
<div class="container align-items-center">
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 align-items-center">
       ...
       <c:if test="${fn:containsIgnoreCase(car.vin,vin)}">
		<c:set var = "car" scope = "session" value="${car}"/>
		<div class="col purchasecard">
